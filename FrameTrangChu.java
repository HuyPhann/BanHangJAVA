...
public class FrameTrangChu extends JFrame implements ActionListener{
	...
	private void createGUI() {
		...
		//thong ke
		btnThongKeChiTieuKhachHang.addActionListener(AddSwithPanel(new gui_ThongKe.ThongKeDoanhThuTheoKhachHang()));
	...
	//	btnTimKiemHoaDon.addActionListener(AddSwithPanel(new gui_HoaDon.TimKiemHoaDon()));
		...
		btnCapNhatChuongTrinhKhuyenMai.addActionListener(AddSwithPanel(new gui_KhuyenMai.CapNhatKhuyenMai()));
	...
	public void actionPerformed(ActionEvent e) {
		...
		}else if(o.equals(btnDonHang)) {
			swithPanel(new gui_KhachHang.DonHang());
